                    ...
                    <?php } ?>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div id="img_src_main" class="dm-uploader p-5 text-center">
                                     ...
                                     <div class="btn btn-primary mb-5">
                                        ...
                                        <input type="file" name="hwt_multi_img" title='Click to add Files' />
                                     </div>
                                     <div class="">  
                                  ...
                                  if(isset($edit)) {
                                     if($edit['img_src'] != '') {
                                        $editImages = json_decode($edit['img_src'],true);
                                        ?>
                                        <div class="row">
                                        <?php
                                        foreach ($editImages as $img_key => $image) {
                                           ...
                                           ?>
                                           <div class="col-md-3 delete_<?= $image ?> ">
                                              <span class="multi_delete" data-value="<?= $image ?>" ><i class="fa fa-trash" ></i></span>
                                              <img src="<?php echo APP_URL.$img_path.'/'.$image; ?>" class="img img-responsive" alt="Photos" height="50px">
                                           </div>
                                           <?php
                                           }
                                        }
...
$(function(){
  ...
  $('#img_src_main').dmUploader({ //
     ...
     onUploadSuccess: function(id, data) {
        ...
        // You should probably do something with the response data, we just show it
        // this.find('input[type="text"]').val(customData.path);
        let bulletinImagesVal = $('#img_src').val();
        let newArr = [];
