                            ...
                            <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <select name="cat_id" id="cat_id" class="form-control" onchange="get_sub_cat()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php if(isset($edit) && $edit['size']!='' ) { echo $edit['size']; } else { set_value('size'); } ?>" id="size" name="size" maxlength="128">
                                    </div>

                                    <!-- <div class="form-group">
                                        <label for="title"># Code</label>
                                        <input type="text" class="form-control required" value="<?php if(isset($edit) && $edit['code']!='' ) { echo $edit['code']; } else { set_value('code'); } ?>" id="code" name="code" maxlength="128">
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="is_featured" id="is_featured" value="1"  <?php if(isset($edit) && $edit['is_featured']=='1') { echo 'checked'; } else { ""; } ?> >
                                    </div>
                                </div>
