                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value='<?php if(isset($edit) && $edit['icon']!='' ) { echo $edit['icon']; } else { set_value('icon'); } ?>' id="icon" name="icon">
                                    </div>
                                    ...
                                    <div class="mb-3 dm-uploader" id="image">
                                       <div class="row">
                                          ...
                                          <span>Image size should be : 160 * 200 </span>
                                    </div>
