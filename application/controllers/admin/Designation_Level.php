...
class Designation_Level extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->isLoggedIn();
        $this->table = "designation_level";   
        $this->id = "id";  
        $this->MainTitle = "Designation Level";
        $this->folder = "designation_level/"; 
        $this->Controller = "Designation_Level"; 
        $this->url = "designation_level";
