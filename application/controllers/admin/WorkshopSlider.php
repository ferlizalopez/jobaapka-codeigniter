...
class WorkshopSlider extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->isLoggedIn();
        $this->table = "workshop_slider";   
        $this->id = "id";  
        $this->MainTitle = "Workshop Slider";
        $this->folder = "workshop_slider/"; 
        $this->Controller = "WorkshopSlider"; 
        $this->url = "workshop_slider";
        $this->img_path = IMG_WORKSHOPSLIDER; 

        $this->img_height = 1600; 
        $this->img_width = 650;
        $this->isthumb = true;
    }
