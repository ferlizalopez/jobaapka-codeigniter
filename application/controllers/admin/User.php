...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['total_customers'] = ''; //count($this->HWT->get_result("hwt_user","id",array("isDelete"=>0,"status"=>1)));;
        $this->global['total_types'] = ''; //count($this->HWT->get_result("subcategory","subcat_id",array("isDelete"=>0,"status"=>1)));;;
