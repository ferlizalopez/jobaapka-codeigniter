...
class Job_Function extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->isLoggedIn();
        $this->table = "job_function";   
        $this->id = "id";  
        $this->MainTitle = "Job Function";
        $this->folder = "job_function/"; 
        $this->Controller = "Job_Function"; 
        $this->url = "job_function";
